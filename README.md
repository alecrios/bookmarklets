...
**Get Placeholder Image** - Generates a placeholder image with custom dimensions (uses http://picsum.photos/).
...
**Get Placeholder Text** - Generates placeholder text of a specified word count (uses lorem ipsum).
